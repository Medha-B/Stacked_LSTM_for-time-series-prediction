...
#lstm expects the data to be of the form [samples, time steps, features]. currently data is in teh form of [samples, features]. so, the data needs to be reshaped uch that it includes the required time step.
